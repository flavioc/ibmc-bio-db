...
mysql -h $HOSTNAME -u $USERNAME -D $DATABASE --password=$PASSWORD -e "INSERT INTO user(name, complete_name, password, email, user_type, birthday) VALUES('flavio', 'Flavio Cruz', 'ibmc123', 'flaviocruz@gmail.com', 'admin', '1986-12-11')"
