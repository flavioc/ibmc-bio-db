...
To begin, we can generate sub-sequences using a position label from the result list. For example,
...
The last section (Figure \ref{fig:search3_man}) present in the search page is the preview section. In it
